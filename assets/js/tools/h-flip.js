 ...
 * Flips the image horizontally. No controls needed.
 * Instant flip using Utils.flipCanvas(canvas, true).
 */
document.addEventListener('DOMContentLoaded', () => {
  ...
  function processImage() {
    ...
    const flipped = Utils.flipCanvas(canvas, true);
  ...
  if (downloadBtn) {
    downloadBtn.addEventListener('click', () => {
      Utils.downloadCanvas(canvas, originalFilename + '_hflip', 'png');
    });
  }
