/**
 * Hue Tool
 * Rotates the hue of an image by a specified number of degrees.
 * Controls: range#hue (0 to 360, default 0)
 */
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ── Process image with hue rotation ──
  ...
  if (hueSlider) {
    hueSlider.addEventListener('input', debouncedProcess);
  }
  ...
  if (resetBtn) {
    resetBtn.addEventListener('click', () => {
      ...
      processImage();
      Utils.showToast('Hue reset to default', 'info');
    });
  }
